...
<html>
    ...
    <c:if test="${pageContext.request.userPrincipal.name != null}">
        ...
        <a class="nav-link dropdown-toggle btn btn-secondary" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <!-- Custom Stylesheet -->
    <link href="${contextPath}/assets/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
    ...
    <img class="logo-abbr" src="${contextPath}/assets/images/logo.png" alt="">
    <img class="logo-compact" src="${contextPath}/assets/images/logo-text.png" alt="">
    <img class="brand-title" src="${contextPath}/assets/images/logo-text.png" alt="">
    </a>
    ...
    <c:if test="${pageContext.request.userPrincipal.name != null}">
        <li class="nav-item dropdown">
        <a class="" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Hello
        ${pageContext.request.userPrincipal.name}</a>
    ...
    <c:if test="${pageContext.request.userPrincipal.name != null}">
        ...
        <li><a href="${contextPath}/usermodel">Management User</a></li>
        <li><a href="${contextPath}/product">Management Product</a></li>
        </ul>
        </li>
        </ul>
    </c:if>
