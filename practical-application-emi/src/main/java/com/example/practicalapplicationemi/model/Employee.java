package com.example.practicalapplicationemi.model;
...
public class Employee {
    ...
    public Employee(String employeeName, double loan_amount, double rate_of_interest, double team_of_the_loan, double emi_total, Date created, Date updated, Customer customer) {
